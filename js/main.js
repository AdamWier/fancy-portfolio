...
document.getElementById("cabinetmap").innerHTML = '<area shape="rect" coords="0,0,' + currentWidth + ',' + y1 + '" href="adam.com" alt="about me">' +
'<area shape="rect" coords="0,'+ y1 + ',' + currentWidth + ',' + y2 + '" href="samantha.com" alt="about me">' +
'<area shape="rect" coords="0,'+ y2 + ',' + currentWidth + ',' + y3 + '" href="mom.com" alt="about me">' +
'<area shape="rect" coords="0,'+ y3 + ',' + currentWidth + ',' + y4 + '" href="jeremy.com" alt="about me">' + 
'<area shape="rect" coords="0,'+ y4 + ',' + currentWidth + ',' + y5 + '" href="jeremy.com" alt="about me">' +
'<area shape="rect" coords="0,'+ y5 + ',' + currentWidth + ',' + y6 + '" href="al.com" alt="about me">'+
'<area shape="rect" coords="0,'+ y6 + ',' + currentWidth + ',' + y7 + '" href="mauricette.com" alt="about me">'
}
